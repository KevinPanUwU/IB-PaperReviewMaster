        ...
        if (type === 1) { // Insert
            ...
            for (let i = 0; i < sortedCuts.length - 1; i++) {
                ...
                if (activeH) {
                    ...
                    if (activeH.type === 'positive') classes += "bg-green-100 text-green-900 ";
                    else if (activeH.type === 'negative') classes += "bg-red-100 text-red-900 ";
                    else classes += "bg-yellow-100 text-yellow-900 ";
  ...
  return (
    <div className="h-full bg-paper-white overflow-y-auto p-8 flex justify-center pb-32">
      <div className="w-full max-w-3xl bg-white shadow-sm min-h-[80vh] h-fit p-12">
        <div
            className="whitespace-pre-wrap font-serif text-lg leading-relaxed text-gray-800"
